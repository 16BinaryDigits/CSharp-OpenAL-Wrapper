...
namespace OpenAL
{
    ...
    internal class OpenAL
    {
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alBufferData(uint buffer, int format, byte[] data, int size, int freq);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBufferf(uint buffer, int pname, out float value);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBuffer3f(uint buffer, int pname, out float v1, out float v2, out float v3);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBufferfv(uint buffer, int pname, out float[] value);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBufferi(uint buffer, int pname, out int value);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBuffer3i(uint buffer, int pname, out int v1, out int v2, out int v3);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBufferiv(uint buffer, int pname, out int[] value);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetSourcefv(uint source, int param, out float[] values);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetSourceiv(uint source, int param, out int[] values);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetListenerfv(int param, out float[] values);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetListeneriv(int param, out int[] values);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetBooleanv(int param, out bool data);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetDoublev(int param, out double data);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetFloatv(int param, out float data);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alGetIntegerv(int param, out int data);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern string alGetString(int param);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr alcGetProcAddress(IntPtr device, [MarshalAs(UnmanagedType.LPStr)] string funcName);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int alcGetEnumValue(IntPtr device, [MarshalAs(UnmanagedType.LPStr)] string enumName);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern string alcGetString(IntPtr device, int param);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alcGetIntegerv(IntPtr device, int param, int size, out int data);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr alcCaptureOpenDevice([MarshalAs(UnmanagedType.LPStr)] string devicename, int frequency, int format, int buffersize);

        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool alcCaptureCloseDevice(IntPtr device);
        ...
        [DllImport(libraryPath, CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void alcCaptureSamples(IntPtr device, out byte[] buffer, int samples);
    }
}